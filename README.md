# docker-lnmp
docker-compose+docker+nginx+mysql+php7.3+swoole4.4++redis+rabbitmq3.7++elk  基于docker容器+swoole一键化部署打造性能最好的PHP开发部署环境

使用Docker 部署 LNMP+Redis+Swoole+Rabitmq+elk 环境
